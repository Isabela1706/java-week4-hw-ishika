...
public class PalindromeNumber {
    public static void main(String[] args) {
        //isPalindrome method can be called direct as it is static method
        System.out.println("isPalindrome(-1221): " + isPalindrome(-1221));//Expected output
        System.out.println("isPalindrome(707): " + isPalindrome(707));//Expected output
        System.out.println("isPalindrome(11212): " + isPalindrome(11212));//Expected output
        System.out.println("isPalindrome(121): " + isPalindrome(121));//Expected output
        System.out.println("isPalindrome(12321): " + isPalindrome(12321));//Expected output
        System.out.println("isPalindrome(1001): " + isPalindrome(1001));//Expected output
    ...
    public static boolean isPalindrome(int number) {
        ...
        //To handle negative numbers, we convert the number to a positive one
